    ...
    <div className="flex mf:flex-row flex-col items-center justify-center md:px-20 md:py-7 p-12">
      ...
      <div className="flex-1 flex flex-col justify-start items-center space-y-6">
        <ServiceCard
          ...
          subtitle=" Your data's safety is our priority. We ensure strict privacy, maintaining data integrity and top-notch product quality. Trust us to safeguard your interests with unwavering commitment to security, privacy, and excellence"
        />
        <ServiceCard
          color="bg-[#8945F8]"
          title="Global Reach"
          icon={<BiSearchAlt fontSize={28} className="text-white" />}
          subtitle="Our services extend across the globe, ensuring accessibility and support wherever you are. We are dedicated to maintaining the utmost security, respecting privacy, and delivering top-notch quality on a global scale."
        />
        <ServiceCard
          color="bg-[#32A852]"
          title="Unbeatable Affordability"
          icon={<FaMoneyBillWave fontSize={28} className="text-white" />}
          subtitle="We prioritize your budget without compromising quality. Our services are designed to offer exceptional value, ensuring accessibility, reliability, and cost-effectiveness. Rely on us to deliver affordability alongside uncompromised excellence."
        />
        <ServiceCard
          color="bg-[#F84550]"
          title="Enduring Lifetime Benefits"
          icon={<RiHeart2Fill fontSize={28} className="text-white" />}
          subtitle="Our commitment goes beyond the present moment. Experience lasting advantages with our services that stand the test of time. Count on us for solutions that provide sustained value, quality, and reliability throughout your journey."
        />
      </div>
    </div>
  </div>
